...
namespace Projeto_Venda_2023.view
{
    public partial class frmTipo : Form
    {
        ...
        private void tsbSalvar_Click(object sender, EventArgs e)
        {
            ...
            {
                Tipo tipo = new Tipo();
                tipo.Cod = Int32.Parse(txtId.Text);
                tipo.Nome = txtNome.Text;

                C_Tipo c_tipo = new C_Tipo();
                c_tipo.editaDados(tipo);
            }
            carregarTabela();
            txtNome.Enabled = false;
            txtNome.Clear();
        ...
        private void btnBuscar_Click(object sender, EventArgs e)
        {
            try
            {
                string sqlBuscarId = "select * from tipo where nome LIKE @nome order by nome";
                ...
                if (tabtipo.Read())
                {
                    txtId.Text = tabtipo["Cod"].ToString();
                    txtNome.Text = tabtipo["Nome"].ToString();
